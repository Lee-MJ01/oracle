...
insert into customer VALUES('361-23-42689','(주)정보산업', 2,'031-563-1253','경기도 광명시');
insert into customer VALUES('103-23-51094','부산의원', 2,'051-581-1010','부산시 남구');
...
insert into account VALUES('101-11-2002','s1', '자유저축예금','361-23-42689',4201000, '2008-12-30 12:32:59');
...
--실습 3-26
select a.acc_no as 계좌번호, a.acc_name as 계좌이름, c.c_id as "주민번호(사업자번호)", c.c_name as 고객명, a.acc_balance as 현재잔액
from customer c join account a on c.c_id = a.acc_cid
where a.acc_balance >= 1000000
